# SC2002 Internship Placement Management System CLI

### To Make Changes
1.  **Pull latest changes:** `git checkout main` and then `git pull origin main`
2.  **Create a new branch:** `git checkout -b examplefeature/your-component-name`.
